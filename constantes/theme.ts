...
export const themesSimulation = {
  light: {
    ...
    math: {
      ...
      neutral: '#AAB18E',
      fieldStrong: '#5F7FA8',
      fieldWeakGreen: '#7D9365',
      fieldWeakBlue: '#7897BD',
      softBlue: 'rgba(111, 149, 200, 0.25)',
      softGreen: 'rgba(111, 181, 168, 0.22)',
      softRed: 'rgba(201, 120, 105, 0.2)',
      softYellow: 'rgba(201, 154, 70, 0.18)',
      glowYellow: 'rgba(201, 154, 70, 0.22)',
  ...
  dark: {
    ...
    math: {
      ...
      neutral: '#9FB19D',
      fieldStrong: '#86A9D6',
      fieldWeakGreen: '#91AB7A',
      fieldWeakBlue: '#7898C2',
      softBlue: 'rgba(134, 169, 214, 0.22)',
      softGreen: 'rgba(121, 191, 178, 0.18)',
      softRed: 'rgba(209, 134, 121, 0.18)',
      softYellow: 'rgba(214, 172, 90, 0.16)',
      glowYellow: 'rgba(214, 172, 90, 0.2)',
